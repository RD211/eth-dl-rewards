...
from data_generation.preference import preference_function as PREF_FUNC
from data_generation.preference import Preference
...
@hydra.main(config_path="config/data_generation", version_base=None)
